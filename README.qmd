...
- Manuscripty double-spaced PDF through Typst (`hikmah-manuscript-typst`)
...
- Default version of `template.qmd`:
  ...
  - Fancy PDF version through Typst: [examples/hikmah-testing-default-typst.pdf](examples/hikmah-testing-default-typst.pdf)
  ...
  - Manuscripty double spaced version through Typst: [examples/hikmah-testing-default-manuscript-typst.pdf](examples/hikmah-testing-default-manuscript-typst.pdf)
...
- Custom fonts + `biblatex-chicago`:
  ...
  - Fancy PDF version through Typst: [examples/hikmah-testing-custom-typst.pdf](examples/hikmah-testing-custom-typst.pdf)
  ...
  - Manuscripty double spaced version through Typst: [examples/hikmah-testing-custom-manuscript-typst.pdf](examples/hikmah-testing-custom-manuscript-typst.pdf)
...
```{r fig.width=4, out.width="100%", echo=FALSE}
#| fig-link: examples/thumbnails/hikmah-testing-default-typst-pdf.png
knitr::include_graphics("examples/thumbnails/hikmah-testing-default-typst-pdf.png", dpi = 600)
```

### Fancy PDF through typst, custom fonts

```{r fig.width=4, out.width="100%", echo=FALSE}
#| fig-link: examples/thumbnails/hikmah-testing-custom-typst-pdf.png
knitr::include_graphics("examples/thumbnails/hikmah-testing-custom-typst-pdf.png", dpi = 600)
```

### Manuscripty PDF through Typst, default settings

```{r fig.width=4, out.width="100%", echo=FALSE}
#| fig-link: examples/thumbnails/hikmah-testing-default-manuscript-typst-pdf.png
knitr::include_graphics("examples/thumbnails/hikmah-testing-default-manuscript-typst-pdf.png", dpi = 600)
```

### Manuscripty PDF through Typst, custom fonts

```{r fig.width=4, out.width="100%", echo=FALSE}
#| fig-link: examples/thumbnails/hikmah-testing-custom-manuscript-typst-pdf.png
knitr::include_graphics("examples/thumbnails/hikmah-testing-custom-manuscript-typst-pdf.png", dpi = 600)
```
